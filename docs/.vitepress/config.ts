    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "throttle节流", link: "/handWriting/throttle" },
          { text: "debounce防抖", link: "/handWriting/debounce" },
          ...
          { text: "二分搜索的常见情景", link: "/handWriting/binSearchMore" },
          { text: "生成区间内随机数", link: "/handWriting/randomInRange" },
        ],
      },
      {
        text: "浏览器相关",
        items: [
          { text: "从url到页面", link: "/browser/urlToPage" },
          { text: "html解析的简单说明", link: "/browser/urlToPage" },
          { text: "css解析的简单说明", link: "/browser/urlToPage" },
        ],
      },
      {
        text: "网络相关",
